                ...
                <Body style={styles.body}>
                    <Container style={styles.container}>
                        ...
                        {data?.insights && data.insights.length > 0 && (
                            <Section style={styles.section}>
                                <Heading style={styles.heading}>Cashlytic Insights</Heading>
                        ...
                        <Text style={styles.footer}>
                            Thank you for using Cashlytic. Keep tracking your finances for better
                            financial health!
                        </Text>
                    </Container>
                </Body>
            ...
            <Html>
                ...
                <Body style={styles.body}>
                    <Container style={styles.container}>
                        ...
                        <Text style={styles.footer}>
                            Stay on track! Review your spending to avoid overspending this month.
                        </Text>
                    </Container>
                </Body>
            </Html>
